// Vercel serverless function — sends email via Gmail SMTP using nodemailer
// Requires env var: GMAIL_APP_PASSWORD (Gmail App Password, NOT account password)
...
module.exports = async (req, res) => {
  ...
  if (!nodemailer) {
    return res.status(500).json({ error: 'Servicio de email no disponible. Contacta a hola@airoiblueprint.com' });
  }
